...
class Setup:
	...
	def __init__(self, device=None, camres=(320,240), disptype='fullscreen', dispres=(1920,1080), display=None):
		...
		while running:
			...
			if stage == 1:
				...
				if stagevars[1]['thresholdchange'] != None:
					if stagevars[1]['thresholdchange'] == 'up' and self.settings['threshold_1'] < 255:
						self.settings['threshold_1'] += 1
					elif stagevars[1]['thresholdchange'] == 'down' and self.settings['threshold_1'] > 0:
						self.settings['threshold_1'] -= 1
...
class CamEyeTracker:
	...
	def threshold_1_image(self, image):
		...
		th = (self.settings['threshold_1'],self.settings['threshold_1'],self.settings['threshold_1'])
